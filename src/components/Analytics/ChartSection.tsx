...
const ChartSection: React.FC<ChartSectionProps> = ({ limit, userVisit, topCountries }) => {
  const totalUserVisits = userVisit ? Object.values(userVisit).reduce((total, count) => total + count, 0) : 0;
          ...
          <div className="flex flex-col lg:flex-row items-start lg:justify-between lg:items-center p-[18px]">
            <div className="w-full">
              ...
              <div className="flex items-center">
                <h2 className="text-2xl text-[#292828] mr-2 font-semibold">{totalUserVisits}</h2>
