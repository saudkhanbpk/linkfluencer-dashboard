      ...
      <div className="bg-white p-[12px] sm:p-[24px]">
        ...
        <div className="mt-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 my-4">
            ...
            <div className="border h-[300px] flex flex-col justify-between items-start  rounded-2xl w-full">
              <span className="text-[#4C4C4C] font-content whitespace-nowrap px-[20px] py-[20px]">
                Top Sources
              </span>
